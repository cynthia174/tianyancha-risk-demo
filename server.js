...
async function queryCompany(name) {
  ...
  return scoreCompanyV2(registration, { annual, hearings, overview, searchResult, historyNames, changes, debtor, dishonest, highConsumption, equityFreeze, judicialDocs, adminPenalty, businessException, seriousViolation, taxArrears, bankruptcy, cancellation, personCompanies, personRisk });
}
...
server.listen(PORT, '127.0.0.1', () => {
  console.log(`企业风险评分 Demo 已启动：http://127.0.0.1:${PORT}`);
});
